...
// Product images
import imgGC206 from '../../assets/products/lab/gc206_p.jpg';
import imgJTF from '../../assets/products/lab/jtf_p.jpg';

const categories = [
  'All',
  'GC206 Diffusible Hydrogen Measurement System',
  'JTF-20A Series Hydrogen in Steel Measurement System',
];

const products = [
  {
    category: 'GC206 Diffusible Hydrogen Measurement System',
    title: 'GC206 Diffusible Hydrogen Measurement System',
    image: imgGC206,
    description:
      'Diffusible Hydrogen Measurement System GC206. Large amounts of hydrogen in weld metal can cause cracks after welding. This system uses a test piece to measure hydrogen during steel welding. Designed and manufactured in accordance with JIS: Z3118 standards, it is a long-selling product that has also received inquiries from overseas customers.',
    features: [
      'Minimum detectable amount of H₂: 0.0005 mL.',
      'Capsule is removable for easy insertion and removal of test specimens.',
      'Two types of capsules can be used depending on the size of the test piece.',
    ],
  },
  {
    category: 'JTF-20A Series Hydrogen in Steel Measurement System',
    title: 'JTF-20A Series Hydrogen in Steel Measurement System',
    image: imgJTF,
    description:
      'Steel Hydrogen Measurement System. This system uses thermal desorption analysis (TDA) to raise the furnace temperature from low to high at a constant rate, continuously measuring the amount of hydrogen released with temperature change using gas chromatography.',
    features: [
      'Trace amounts of hydrogen measured using the TDA method with gas chromatography.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-start">
            ...
            <div className="flex items-center space-x-2 text-sm text-gray-400">
              ...
              <span>/</span>
              <span className="text-blue-400 font-medium">Lab Use GC</span>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="flex-1 p-6 lg:p-8 flex flex-col">
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100">
                      <div className="flex flex-wrap items-center gap-3">
                        <button onClick={() => addProduct(product.title)} className="inline-flex items-center justify-center bg-white border border-gray-200 text-gray-900 font-semibold py-2.5 px-6 rounded-xl shadow-sm hover:border-gray-300 hover:bg-gray-50 transition-colors text-sm">
                          {isProductAdded(product.title) ? 'Added' : 'Add'}
                        </button>
                        <button onClick={() => navigate('/contact')} disabled={!hasProducts} className="inline-flex items-center justify-center bg-blue-600 border border-blue-600 text-white font-semibold py-2.5 px-6 rounded-xl shadow-sm hover:bg-blue-700 transition-colors text-sm disabled:opacity-50 disabled:cursor-not-allowed">
                          Get Quote
                        </button>
